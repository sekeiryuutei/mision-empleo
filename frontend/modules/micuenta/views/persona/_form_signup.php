        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <?= $form->field($model, 'indTelefonoContacto')->widget(\yii\widgets\MaskedInput::className(), [
                        'mask' => '999',
                ])->textInput(['id' => 'indtelefonocontacto', 'required' => true])->label('Indicativo') ?>
            </div>
            
            <div class="col-lg-3">
                <?= $form->field($model, 'telefonoContacto')->widget(\yii\widgets\MaskedInput::className(), [
                        'mask' => '9999999999',
                ])->textInput(['id' => 'telefonoontacto'])->label('Teléfono 2') ?>
            </div>
...
<div class="card">
    ...
    <div class="card-header text-center titulo-seccion-FAA">
        <strong><h5>INFORMACIÓN MI CUENTA</h5></strong>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <?= $form->field($model, 'correoElectronico')->input('email')->label('Correo Electrónico') ?>
            </div>
        </div>
